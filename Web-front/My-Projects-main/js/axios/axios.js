/*! Axios v1.10.0 Copyright (c) 2025 Matt Zabriskie and contributors */ ! function(e, t) {
    ...
    var ut, ct, ft = function(e) {
            var t, r, n = st({}, e),
                ...
                u = n.headers,
                c = n.auth;
            if (n.headers = u = Ve.from(u), n.url = je(it(n.baseURL, n.url, n.allowAbsoluteUrls), e.params, e.paramsSerializer), c && u.set("Authorization", "Basic " + btoa((c.username || "") + ":" + (c.password ? unescape(encodeURIComponent(c.password)) : ""))), ve.isFormData(o))
